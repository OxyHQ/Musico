...
// Spotify-like color scheme - Green accent color
...
export const colors = {
  ...
  primaryDark: '#121212', // Spotify dark background
  primaryDark_1: '#181818', // Spotify card/panel background
  primaryDark_2: '#2A2A2A', // Lighter dark for hover states
